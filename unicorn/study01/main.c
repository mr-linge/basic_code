...
int main()
{
    ...
    */
    ...
    // 往寄存器中写入数据
    uc_reg_write(uc, UC_ARM64_REG_X1, &regs.ARM_x1);
    uc_reg_write(uc, UC_ARM64_REG_X2, &regs.ARM_x2);
    uc_reg_write(uc, UC_ARM64_REG_X3, &regs.ARM_x3);
    ...
    */
    ...
    // 读取寄存器中的数据
    uc_reg_read(uc, UC_ARM64_REG_X0, &regs.ARM_x0);
    uc_reg_read(uc, UC_ARM64_REG_X1, &regs.ARM_x1);
    uc_reg_read(uc, UC_ARM64_REG_X2, &regs.ARM_x2);
    uc_reg_read(uc, UC_ARM64_REG_X3, &regs.ARM_x3);
    printf("x0 = 0x%llx\n", regs.ARM_x0);
    printf("x1 = 0x%llx\n", regs.ARM_x1);
    printf("x2 = 0x%llx\n", regs.ARM_x2);
    printf("x3 = 0x%llx\n", regs.ARM_x3);
