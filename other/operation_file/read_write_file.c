...
char *path = "/home/dio/Desktop/t2/hope.txt";
...
int main() {
    ...
    Message *msg_src = (Message *) malloc(sizeof(Message));
    msg_src->message = "Add some new thing! Life is long, you also have many chances!";
    msg_src->len = strlen(msg_src->message);
    write_message(path, msg_src);
