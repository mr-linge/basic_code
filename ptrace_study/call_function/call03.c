...
int main(int argc, char **argv)
{
	...
	get_registers(pid,&breakpoint_regs);
...
//	printf("%s %d\n", __FILE__, __LINE__);
	...
	wait_breakpoint();
        struct user_regs_struct callback_regs;
        get_registers(pid,&callback_regs);
	long long return_value = callback_regs.rax;
